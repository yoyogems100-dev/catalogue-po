...
export default async function AdminDashboard() {
  ...
  const queues = [
    { title: 'Orders placed today', href: `/admin/orders?from=${today}&to=${today}`, query: supabaseAdmin.from('orders').select('id', {count:'exact',head:true}).gte('created_at', `${today}T00:00:00+05:30`).lte('created_at', `${today}T23:59:59.999+05:30`) },
