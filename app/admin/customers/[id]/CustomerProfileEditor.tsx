...
export default function CustomerProfileEditor({ customer, categories }: { customer: Customer; categories: { id: number; name: string }[] }) {
  ...
  return <section className="card admin-profile-editor">
    ...
    <p style={{ fontSize: 12.5, color: '#756e5c', margin: '0 0 10px' }}>What this buyer means by a colour. When they order by colour alone (Quick Order or the home page colour chips), the stone and grade fill in from here.</p>
