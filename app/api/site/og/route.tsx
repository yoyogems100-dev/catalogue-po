...
// and brand blue, in Playfair. /api/site/og?title=Moissanite
...
export async function GET(req: Request) {
  ...
  return new ImageResponse(
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '64px 72px', backgroundColor: '#0a0a0c', backgroundImage: 'radial-gradient(circle at 88% 12%, rgba(60, 111, 196, 0.5) 0%, rgba(60, 111, 196, 0.18) 30%, rgba(10,10,12,0) 58%)', color: '#fff' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
          <div style={{ display: 'flex', width: 120, height: 5, borderRadius: 5, background: 'linear-gradient(90deg, #1b3a6b, #2a5298, #3c6fc4)' }} />
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 24, color: '#adb3bf' }}>
          <span>{title ? 'Synthetic Gemstones. Infinite Choices. One Trusted Name.' : 'Wholesale loose gemstones · Jaipur'}</span>
          <span style={{ color: '#a9c4ef' }}>yoyogems.co.in</span>
        </div>
      </div>
    ),
